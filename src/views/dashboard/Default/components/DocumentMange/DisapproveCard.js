...
const DisapproveCard = ({ isLoading }) => {
    ...
    function getData(value) {
        ...
        axios
            .get(`https://banpho-database.herokuapp.com/document-card-manager/${id}/${role}/${status}`)
            .then((response) => {
...
DisapproveCard.propTypes = {
    isLoading: PropTypes.bool
};

export default DisapproveCard;
