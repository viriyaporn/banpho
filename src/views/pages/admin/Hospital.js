...
const Hospital = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .post(`https://banpho-database.herokuapp.com/hospital`, {
                name: name,
                address: address,
                phone: phone
            })
    ...
    const handleOpenEdit = (row) => {
        ...
        console.log(name);
        axios
            .get(`https://banpho-database.herokuapp.com/hospital/${name}`)
            .then((response) => {
    ...
    const handleSubmitEdit = (event) => {
        ...
        const phone = event.target.elements.phone.value;
        axios
            .put(`https://banpho-database.herokuapp.com/hospital/${id}`, {
                name: name,
                address: address,
                phone: phone
            })
    ...
    const handleSubmitDelete = () => {
        const id = hospital?.hospital_id;
        axios
            .delete(`https://banpho-database.herokuapp.com/hospital/${id}`)
            .then((response) => {
                getData();
                setOpenDelete(false);
            })
    ...
    const getData = () => {
        axios
            .get(`https://banpho-database.herokuapp.com/hospital`)
            .then((response) => {
