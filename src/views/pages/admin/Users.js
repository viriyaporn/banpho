...
const Users = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .post(`https://banpho-database.herokuapp.com/user`, {
                username: username,
                password: password,
                firstname: firstname,
                lastname: lastname,
    ...
    const handleSubmitEdit = (event) => {
        ...
        const hospital_id = event.target.elements.hospital.value;
        axios
            .put(`https://banpho-database.herokuapp.com/user/${id}`, {
                firstname: firstname,
                lastname: lastname,
                role: role_status,
                hospital: hospital_id
    ...
    const handleSubmitDelete = () => {
        axios
            .delete(`https://banpho-database.herokuapp.com/users/${id}`)
            .then((response) => {
                getData();
                setOpenDelete(false);
            })
    ...
    const getData = () => {
        axios
            .get(`https://banpho-database.herokuapp.com/users`)
            .then((response) => {
    ...
    const getHospital = () => {
        axios
            .get(`https://banpho-database.herokuapp.com/hospital-list`)
            .then((response) => {
