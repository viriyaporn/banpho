...
const Login = () => {
    ...
    const handleLogin = async (event) => {
        ...
        axios
            .post('https://banpho-database.herokuapp.com/login', {
                username: username,
                password: password
            })
            .then(function (response) {
                ...
                if (value.status == 'ok') {
                    ...
                    if (value.data[0].user_role == 'hospital staff') {
                        window.location.href = ' https://banpho-webapp.herokuapp.com/home';
                    } else if (value.data[0].user_role == 'admin') {
                        window.location.href = ' https://banpho-webapp.herokuapp.com/';
                    } else {
                        window.location.href = ' https://banpho-webapp.herokuapp.com/dashboard-documents';
                    }
                } else {
                    setCheckLogin(true);
                    console.log('error');
