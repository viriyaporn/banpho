...
const Notification = () => {
    ...
    function getData(value) {
        ...
        axios
            .get(`https://banpho-database.herokuapp.com/notification/${role}/${hospital}`)
            .then((response) => {
    ...
    const readAll = () => {
        ...
        axios
            .put('https://banpho-database.herokuapp.com/notification/read-all', {
                hospital: hospital,
                role: role
            })
            .then(function (response) {
                if (role == 1) {
                    ...
                    window.location.href = ' https://banpho-webapp.herokuapp.com/report-documents';
                }
            })
