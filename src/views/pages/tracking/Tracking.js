...
const Tracking = () => {
    ...
    function getData(value) {
        ...
        axios
            .get(`https://banpho-database.herokuapp.com/tracking/${id}/${status}`)
            .then((response) => {
    ...
    const handleCheck = (row) => {
        ...
        axios
            .get(`https://banpho-database.herokuapp.com/tracking-data/${track}`)
            .then((response) => {
        ...
        axios
            .get(`https://banpho-database.herokuapp.com/tracking-item/${track}`)
            .then((response) => {
    ...
    const handleSaveForm = () => {
        axios
            .post('https://banpho-database.herokuapp.com/create-tracking', {
                id: track,
                items: equipment,
